...
* UI:
  ...
  * Drag Dimensions Overlay: Added 3D alignment lines, tick marks, and floating metric labels (left offset, right offset, width, height, and elevation) that show while dragging sub-objects (doors, windows, passages), with a global sidebar toggle to disable/enable it.
